...
export const personalProjects: Project[] = [
  ...
  },
  {
    ...
    description: 'Posters for the original Looney Tunes show.',
    tech: ['Photoshop'],
  ...
  },
  {
    ...
    description: 'Posters for the One Pace fan-edit project.',
    tech: ['Photoshop'],
    image: onePacePostersHeader,
  ...
  },
  {
    ...
    description: 'Posters for the Tom & Jerry shows and movies.',
    tech: ['Photoshop'],
